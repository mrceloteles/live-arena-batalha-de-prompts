...
2. code.html determina a identidade visual aprovada.
...
code.html: protótipo ajustado. portal-corrigido.png: captura atual. screen.png: captura ORIGINAL enviada pelo gerador (não representa a versão corrigida). Tailwind e fontes são carregados pela internet. O pacote não contém credenciais nem dados do banco real.
